    ...
    <footer className="w-full pt-8">
      ...
      <div className="w-full px-8 lg:px-16 py-4 flex flex-col lg:flex-row justify-center lg:justify-between items-center">
        <div className="flex items-center space-x-2 order-3 lg:order-1 mt-4 lg:mt-0">
          {logoURL ? (
            <img
              className="hidden lg:block h-10 w-10 object-cover rounded-full"
              src={logoURL}
              alt=""
            />
          ) : (
            <span className="hidden lg:inline-block text-4xl text-purple-800">
              <i className={logoIconClass}></i>
            </span>
          )}
          <span className="hidden lg:block text-2xl text-gray-700 font-semibold lowercase">
            {name}
          </span>
